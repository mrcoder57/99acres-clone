...
const Searchmobile = () => {
  return (
    <div className="absolute lg:hidden  top-[235px] left-[3vh] shadow-xl flex flex-col w-[360px] h-[7vh] rounded-xl bg-white">
 <div className=" flex flex-row items-center mx-3 gap-16 mt-3">
